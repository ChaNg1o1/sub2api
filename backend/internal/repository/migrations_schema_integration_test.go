...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "usage_logs", "openai_ws_queue_wait_ms", "integer", 0, true)
	requireColumn(t, tx, "usage_logs", "openai_ws_conn_pick_ms", "integer", 0, true)
	requireColumn(t, tx, "usage_logs", "openai_ws_conn_reused", "boolean", 0, true)
